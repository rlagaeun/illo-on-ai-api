...
@router.post(
    "/{user_id}/{resume_id}/analyze/score",
...
def analyze_score(
    ...
    return {
        ...
        "resume_id": resume_id,
        **portfolio_status,
        "score_result": HARDCODED_SCORE
    }


@router.post(
    "/{user_id}/{resume_id}/analyze/feedback",
...
def analyze_feedback(
    ...
    return {
        ...
        "user_id": user_id,
        "resume_id": resume_id,
        "feedback_id": "feedback-hardcoded-001",
        **portfolio_status,
        "feedback_result": HARDCODED_FEEDBACK
    }


@router.post(
    "/{user_id}/{resume_id}/analyze/activities",
...
def analyze_activities(
    ...
    return {
        ...
        "feedback_id": "feedback-hardcoded-001",
        **portfolio_status,
        "activity_result": HARDCODED_ACTIVITIES
    }
